...
public class AddressTests {
    ...
    public void testAddress() {
        ...
        // System.out.println("self addess  value " + adrTwo.getSelfAddress());
    ...
    public void testWriteAndReadDataStream() {
        try {
            ...
            // System.out.println("self  value " + a.toString());
    ...
    @Test
    public void testMakeSelfAddress() {

        MiniData i = new MiniData("0xffffffffffffffffffffffffffffffffffffffff");

        String mxAddress = Address.makeSelfAddress(i);
        MiniData j = Address.convertSelfAddress(mxAddress);
        try {
        ...
        String mxAddress1 = Address.makeSelfAddress(q);
        MiniData p = Address.convertSelfAddress(mxAddress1);
        try {
        ...
        String mxAddress3 = Address.makeSelfAddress(l);
        String mxAddress4 = Address.makeSelfAddress(v);
        String mxAddress5 = Address.makeSelfAddress(o);
        MiniData m = Address.convertSelfAddress(mxAddress3);
        MiniData m2 = Address.convertSelfAddress(mxAddress4);
        MiniData m3 = Address.convertSelfAddress(mxAddress5);
