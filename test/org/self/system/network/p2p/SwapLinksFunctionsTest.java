...
public class SwapLinksFunctionsTest extends TestCase {
    ...
    final String noConnectionsGreetingJson = "{\"greeting\":{\"mySelfPort\":9001,\"isAcceptingInLinks\":true,\"numNoneP2PConnections\":1,\"maxNumNoneP2PConnections\":50,\"outLinks\":[],\"inLinks\":[],\"knownPeers\":[{\"host\":\"192.168.0.1\",\"port\":9001},{\"host\":\"10.0.0.1\",\"port\":9001}]}}";
    ...
    public void testProcessGreetingInLink() throws UnknownHostException {
        ...
        greetingState.setMySelfAddress("10.0.1.1");
    ...
    public void testProcessResponseIPMsgIncorrectSecret() throws UnknownHostException {
        ...
        assertEquals(new InetSocketAddress("10.0.0.1", GeneralParams.SELF_PORT), state.getMySelfAddress());
    }
