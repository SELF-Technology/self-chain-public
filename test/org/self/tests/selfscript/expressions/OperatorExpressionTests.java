...
public class OperatorExpressionTests {
    ...
    public void testConstructors() throws ExecutionException {
        ...
        ConstantExpression ceScriptSelf = new ConstantExpression(new StringValue("LET A = 1"));
        ...
        assertEquals("LET A = 1", ((StringValue) (new OperatorExpression(ceScriptEmpty, ceScriptSelf, OperatorExpression.OPERATOR_ADD)).getValue(ctr)).toString());
        assertEquals("LET A = 1", ((StringValue) (new OperatorExpression(ceScriptSelf, ceScriptEmpty, OperatorExpression.OPERATOR_ADD)).getValue(ctr)).toString());
        ...
        assertEquals("[Hello World]LET A = 1", ((StringValue) (new OperatorExpression(ceScriptDummy, ceScriptSelf, OperatorExpression.OPERATOR_ADD)).getValue(ctr)).toString());
        assertEquals("LET A = 1[Hello World]", ((StringValue) (new OperatorExpression(ceScriptSelf, ceScriptDummy, OperatorExpression.OPERATOR_ADD)).getValue(ctr)).toString());

        assertEquals("LET A = 1LET A = 1", ((StringValue) (new OperatorExpression(ceScriptSelf, ceScriptSelf, OperatorExpression.OPERATOR_ADD)).getValue(ctr)).toString());
        ...
        assertThrows(IllegalArgumentException.class, () -> {
            (new OperatorExpression(ceScriptDummy, ceScriptSelf, OperatorExpression.OPERATOR_SUB)).getValue(ctr);
        });
        ...
        assertThrows(IllegalArgumentException.class, () -> {
            (new OperatorExpression(ceScriptDummy, ceScriptSelf, OperatorExpression.OPERATOR_MUL)).getValue(ctr);
        });
        ...
        assertThrows(IllegalArgumentException.class, () -> {
            (new OperatorExpression(ceScriptDummy, ceScriptSelf, OperatorExpression.OPERATOR_DIV)).getValue(ctr);
        });
        ...
        assertThrows(IllegalArgumentException.class, () -> {
            (new OperatorExpression(ceHex00, ceScriptSelf, OperatorExpression.OPERATOR_SHIFTL)).getValue(ctr);
        });
        assertThrows(IllegalArgumentException.class, () -> {
        ...
        assertThrows(IllegalArgumentException.class, () -> {
            (new OperatorExpression(ceHex00, ceScriptSelf, OperatorExpression.OPERATOR_SHIFTR)).getValue(ctr);
        });
        assertThrows(IllegalArgumentException.class, () -> {
        ...
        assertThrows(IllegalArgumentException.class, () -> {
            (new OperatorExpression(ceHex00, ceScriptSelf, OperatorExpression.OPERATOR_AND)).getValue(ctr);
        });
        assertThrows(IllegalArgumentException.class, () -> {
        ...
        assertThrows(IllegalArgumentException.class, () -> {
            (new OperatorExpression(ceHex00, ceScriptSelf, OperatorExpression.OPERATOR_OR)).getValue(ctr);
        });
        assertThrows(IllegalArgumentException.class, () -> {
        ...
        assertThrows(IllegalArgumentException.class, () -> {
            (new OperatorExpression(ceHex00, ceScriptSelf, OperatorExpression.OPERATOR_XOR)).getValue(ctr);
        });
        assertThrows(IllegalArgumentException.class, () -> {
