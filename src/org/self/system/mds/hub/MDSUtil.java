...
public class MDSUtil {
	...
	public static String getSessionIDButton(String zSessionID, String zLink, String zText) {
	...
	public static String returnHeader(String zSessionID, boolean zShowButton, boolean zMainorPending) {
		...
		if(zShowButton) {
			if(zMainorPending) {
				head += getSessionIDButton(zSessionID,"main.html","SELF Menu");
			}else{
	...
	public static String returnLogonHeader() {
