...
import org.self.system.mds.handler.APIAutoResponse;
import org.self.system.mds.handler.APICommand;
import org.self.system.mds.handler.CMDcommand;
import org.self.system.mds.handler.COMMSCommand;
import org.self.system.mds.handler.FILEcommand;
import org.self.system.mds.handler.KEYPAIRcommand;
import org.self.system.mds.handler.MEGAPOLLcommand;
import org.self.system.mds.handler.NETcommand;
import org.self.system.mds.handler.NOTIFYcommand;
import org.self.system.mds.handler.POLLcommand;
import org.self.system.mds.handler.SQLcommand;
...
public class MDSCommandHandler {
	...
	public String runCommand(String minidappid, String command, String data) throws UnsupportedEncodingException, MDSCommandException {
		...
		if(command.equals("sql")) {
			...
			//SelfLogger.log("mini:"+mininame+" type:"+type+" randid:"+randid+" msg:"+msg);
			...
			if(reqmini == null || publicmini) {
				...
				//SelfLogger.log("DAPP LINK : "+data.trim()+" "+reqmini.getName());
			...
			SelfLogger.log("ERROR MDS COMPLETE HANDLER REQ : "+command);
