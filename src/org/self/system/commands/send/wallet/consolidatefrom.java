...
public class consolidatefrom extends Command {
	...
	public consolidatefrom() {
		super("consolidatefrom","[fromaddress:] [address:] [amount:] (tokenid:) [script:] [privatekey:] [keyuses:] (burn:) (mine:) - Send Self or Tokens from a certain address");
	}
	...
	public JSONObject runCommand() throws Exception {
		...
		if(burn.isMore(MiniNumber.ZERO) && !tokenid.equals("0x00")) {
			throw new CommandException("Currently BURN only works for Self.. tokenid:0x00.. not tokens.");
		}
