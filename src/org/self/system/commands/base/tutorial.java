...
public class tutorial extends Command {
	...
	public tutorial() {
		super("tutorial","Show the complete Grammar for Self SELFScript scripting");
	}
	...
	public String getFullHelp() {
		return "\ntutorial\n"
				+ "\n"
				+ "Show the complete Grammar for Self SELFScript scripting.\n"
				+ "\n"
				+ "SELFScript is the scripting language used to write Self scripts/smart contracts.\n"
				+ "\n"
				+ "Examples:\n"
				+ "\n"
				+ "tutorial\n";
