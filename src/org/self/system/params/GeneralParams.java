...
public class GeneralParams {
	...
	/**
	 * The SQL DB Aes Password. If it is 'self' no Encryption used
	 */
	public static boolean IS_MAIN_DBPASSWORD_SET = false;
	public static String MAIN_DBPASSWORD 		 = "self"; 
	 ...
	 * The main Self port
	 */
	public static int SELF_PORT = 9001;
	
	/**
	 * The MDS webserver
	 */
	public static int MDSFILE_PORT = SELF_PORT+2;
	
	/**
	 * The MDS Command Server
	 */
	public static int MDSCOMMAND_PORT = SELF_PORT+3;
	
	/**
	 * The Self RPC port
	 */
	public static int RPC_PORT = SELF_PORT+4;
	...
	/**
	 * Manual list of Self nodes to connect to
	 */
	...
	/**
	 * Do we prune all tokens - only Self allowed
	 */
	...
	public static void resetDefaults() {
		...
		MAIN_DBPASSWORD 		 = "self"; 
		DATA_FOLDER = "";
		BASE_FILE_FOLDER = "";
		SELF_HOST = "";
		IS_HOST_SET = false;
		SELF_PORT = 9001;
		MDSFILE_PORT = SELF_PORT+2;
		MDSCOMMAND_PORT = SELF_PORT+3;
		RPC_PORT = SELF_PORT+4;
		MDS_PASSWORD = "";
		MDS_INITFOLDER = "";
		MDS_WRITE = "";
		MDS_ENABLED = false;
