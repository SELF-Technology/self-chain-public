...
public class Contract {
	...
	/**
	 * Maximum allowed number of SELFScript instructions
	 */
	...
	public void setGlobals(	MiniNumber zBlock,
		...
		//AMOUNT is the amount of Self or Token(Scaled)..
	...
	public void traceLog(String zLog) {
		if(isTrace()) {
			SelfLogger.log("INST["+mNumInstructions+"] STACK["+getStackDepth()+"] - "+zLog);
		}
...
//			}
	 ...
	 */
	public NumberValue getNumberParam(int zParamNumber, SelfFunction zFunction) throws ExecutionException {
	...
	public HexValue getHexParam(int zParamNumber, SelfFunction zFunction) throws ExecutionException {
		Value vv = zFunction.getParameter(zParamNumber).getValue(this);
	...
	public StringValue getStringParam(int zParamNumber, SelfFunction zFunction) throws ExecutionException {
		Value vv = zFunction.getParameter(zParamNumber).getValue(this);
	...
	public BooleanValue getBoolParam(int zParamNumber, SelfFunction zFunction) throws ExecutionException {
		Value vv = zFunction.getParameter(zParamNumber).getValue(this);
...
//		script = script.replaceAll("\\\\","").trim();
		...
		try {
			...
			SelfLogger.log("Clean Script Error @ "+zScript+" "+e);
			return zScript;
		}
...
//		String scr = "LET a = 0xff<<10000";
		...
		SelfLogger.log("");
		SelfLogger.log("Script:"+scr);
		
		String clean = cleanScript(scr,false);
		SelfLogger.log("Clean :"+clean);
