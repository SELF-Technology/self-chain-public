...
import org.self.system.network.p2p.P2PState;
...
public class P2PGreeting {
    ...
    public P2PGreeting(P2PState state) {
        ...
        this.mySelfPort = GeneralParams.SELF_PORT;
        ...
        if (state.getMySelfAddress() != null && state.isAcceptingInLinks()) {
            this.knownPeers.add(state.getMySelfAddress());
        }
     ...
     */
    public P2PGreeting(int mySelfPort, List<InetSocketAddress> knownPeers) {
     ...
     */
    public P2PGreeting(int mySelfPort, boolean isAcceptingInLinks, List<InetSocketAddress> outLinks, List<InetSocketAddress> inLinks, int numNoneP2PConnections, int maxNumNoneP2PConnections, List<InetSocketAddress> knownPeers) {
        this.mySelfPort = mySelfPort;
    ...
    public static P2PGreeting fromJSON(JSONObject jsonObject) {
        ...
        greeting.setMySelfPort(InetSocketAddressIO.safeReadInt(jsonObject, "mySelfPort"));
    ...
    public JSONObject toJson() {
        ...
        json.put("mySelfPort", mySelfPort);
    ...
    public void setMySelfPort(int mySelfPort) {
        this.mySelfPort = mySelfPort;
    }
    ...
    public boolean equals(Object o) {
        ...
        return mySelfPort == c.getMySelfPort()
