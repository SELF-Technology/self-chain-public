...
import org.self.system.network.p2p.P2PPeersChecker;
...
public class peers extends Command {
	...
	public String getFullHelp() {
		return "\npeers\n"
				...
				+ "\n"
				+ "Your peers are the other Self nodes you know about.\n"
				+ "\n"
				+ "action: (optional)\n"
	...
	public JSONObject runCommand() throws Exception{
		...
		//Is the P2P Enable..
		if(!GeneralParams.P2P_ENABLED || SelfDB.getDB().getUserDB().isSlaveNode()) {
