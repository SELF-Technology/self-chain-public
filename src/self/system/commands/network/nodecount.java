...
//                    SelfLogger.log(peersArrayList.toString());
...
//                    SelfLogger.log(peersArrayList.toString());
				...
				SelfLogger.log("Peers Checked: " + pingedPeers.size() + " Scanning... " + scan_percent + "%");
			}
			...
			if (peersToCheck.size() == 0 || scan_percent >= 100){
				...
				SelfLogger.log("Total participating nodes: " + (int) total_nodes + " of which " + (int) total_servers + " are p2p servers and " + (int) clients + " are client nodes." );
