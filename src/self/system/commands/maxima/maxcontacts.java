...
import org.self.system.network.maxima.MaximaContactManager;
...
public class maxcontacts extends Command {
	...
	public String getFullHelp() {
		return "\nmaxcontacts\n"
				...
				+ "\n"
				+ "maxcontacts action:add contact:SxG18H..\n"
				+ "\n"
				+ "maxcontacts action:remove id:1\n"
				+ "\n"
				+ "maxcontacts action:export\n"
				+ "\n"
				+ "maxcontacts action:import contactlist:SxG1FE..,SxG1768..,etc\n"
				+ "\n"
		...
		if(func.equals("list")) {
			...
			if(address.startsWith("MAX#")) {
				...
				if((boolean)maxaddress.get("success")) {
					...
					SelfLogger.log("ATTEMPT ADD MAX CONTACT : "+address);
			...
			if(!maxextra.checkValidSxAddress(address)) {
