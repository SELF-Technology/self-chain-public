	...
	public String runCommand() {
		...
		try {
			...
			if(mFileCommand.equals(FILECOMMAND_LIST)) {
				...
				//Now Write data..
				MiniFile.writeDataToFile(actualfile, mData.getBytes(MiniString.SELF_CHARSET));
				...
				fdata.put("data", new String(data, MiniString.SELF_CHARSET));
			...
			//SelfLogger.log("FILE command : "+mMiniDAPPID+" "+exc);
