...
public class MDSHubUpdate {
	...
	public static String createHubPage(MDSManager zMDS, String zSessionID, String zMiniDAPPID) {
		...
		MiniDAPP dapp 	= SelfDB.getDB().getMDSDB().getMiniDAPP(zMiniDAPPID); 
		...
		page +=   "<li>\n"
				...
				+ "                        <div class=\"app-title\">"+MDSHub.stripHTML(dapp.getName())+"</div>\n"
				+ "                        <div><br>"
				+ "<script>"
				...
				+ "</script>"
				+ ""
				+ "<form action=\"updateminidapp.html\" onSubmit=\"disableButton();\" method=POST enctype='multipart/form-data'>\n"
				...
				+ "  <input class='solobutton' id='updatebutton' type=\"submit\" value='&nbsp;Update&nbsp;'>\n"
				+ "</form>"
				+ "							</div>\n"
				+ "                    </div>\n"
				+ "                </div>\n"
