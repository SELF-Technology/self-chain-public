...
public class RPCClient {
	...
	public static String USER_AGENT = "Self/1.0";
	...
	public static String sendPOST(String zHost, String zParams, String zType) throws IOException {
		...
		os.write(zParams.getBytes(MiniString.SELF_CHARSET));
		os.flush();
		os.close();
		// For POST only - END
		...
		if (responseCode == HttpURLConnection.HTTP_OK) { //success
			BufferedReader in 		= new BufferedReader(new InputStreamReader(con.getInputStream(),MiniString.SELF_CHARSET));
			StringBuffer response 	= new StringBuffer();
	...
	public static String sendGETAuth(String zHost, String zAuthToken) throws IOException {
		...
		//SelfLogger.log("GETAUTH : "+zHost+" "+zAuthToken);
		...
		//SelfLogger.log("GETAUTH RESULT : "+res);
