...
public class MiniFormat {
	...
	public static String JSONPretty(JSONObject zJSONObj, boolean zDebug) {
		...
		if(zDebug) {
			SelfLogger.log("JSONPRETTY len:"+len+" obj:"+zJSONObj.toString());
		}
...
//		}
		...
		try {
			...
			if(zDebug) {
				SelfLogger.log("[!] Error JSONPretty.. return unmodified : "+work,false);
			}
			return work;
		}
