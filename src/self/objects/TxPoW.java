...
//			SelfLogger.log("Weight : "+_mTxPOWIDStr+" "+weight);
//			
//			//What is the weight..
//			_mBlockWeight = weight.toBigInteger();
		...
		if(_mSuperBlock>=GlobalParams.SELF_CASCADE_LEVELS) {
			_mSuperBlock = GlobalParams.SELF_CASCADE_LEVELS-1;
		}
